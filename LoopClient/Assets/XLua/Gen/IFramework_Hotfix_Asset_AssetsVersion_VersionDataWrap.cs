...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixAssetAssetsVersionVersionDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "lastWriteTime", _g_get_lastWriteTime);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "lastWriteTime", _s_set_lastWriteTime);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_lastWriteTime(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                IFramework.Hotfix.Asset.AssetsVersion.VersionData gen_to_be_invoked = (IFramework.Hotfix.Asset.AssetsVersion.VersionData)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushint64(L, gen_to_be_invoked.lastWriteTime);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_lastWriteTime(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                IFramework.Hotfix.Asset.AssetsVersion.VersionData gen_to_be_invoked = (IFramework.Hotfix.Asset.AssetsVersion.VersionData)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.lastWriteTime = LuaAPI.lua_toint64(L, 2);
