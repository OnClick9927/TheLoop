...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DoEnable", _m_DoEnable);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DoEnable(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<bool> gen_ret = gen_to_be_invoked.DoEnable( _end, _duration );
