...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkModulesRecorderCommandStateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Modules.Recorder.CommandState);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					IFramework.Modules.Recorder.CommandState gen_ret = new IFramework.Modules.Recorder.CommandState();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Modules.Recorder.CommandState constructor!");
        ...
        static int _m_Clone(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Modules.Recorder.CommandState gen_to_be_invoked = (IFramework.Modules.Recorder.CommandState)translator.FastGetCSObj(L, 1);
		    ...
		    try {
                ...
                
                {
                    ...
                    IFramework.ICommand _undo = (IFramework.ICommand)translator.GetObject(L, 3, typeof(IFramework.ICommand));
                        ...
                        IFramework.Modules.Recorder.CommandState gen_ret = gen_to_be_invoked.SetCommand( _redo, _undo );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Subscribe(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Modules.Recorder.CommandState.Subscribe!");
