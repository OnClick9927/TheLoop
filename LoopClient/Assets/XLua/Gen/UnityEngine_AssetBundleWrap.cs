...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAssetBundleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SetAssetBundleDecryptKey", _m_SetAssetBundleDecryptKey_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetAssetBundleDecryptKey_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.AssetBundle.SetAssetBundleDecryptKey( _password );
