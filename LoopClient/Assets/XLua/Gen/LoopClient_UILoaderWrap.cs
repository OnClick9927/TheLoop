...
namespace XLua.CSObjectWrap
{
    ...
    public class LoopClientUILoaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LoopClient.UILoader);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LoopClient.UILoader gen_ret = new LoopClient.UILoader();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LoopClient.UILoader constructor!");
        ...
        static int _m_Load(RealStatePtr L)
        {
		    try {
                ...
                LoopClient.UILoader gen_to_be_invoked = (LoopClient.UILoader)translator.FastGetCSObj(L, 1);
