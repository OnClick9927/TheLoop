...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixLuaLuaGroupsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "onFindPanel", _e_onFindPanel);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_onFindPanel(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
			IFramework.Hotfix.Lua.LuaGroups gen_to_be_invoked = (IFramework.Hotfix.Lua.LuaGroups)translator.FastGetCSObj(L, 1);
                System.Func<string, IFramework.UI.UIPanel> gen_delegate = translator.GetDelegate<System.Func<string, IFramework.UI.UIPanel>>(L, 3);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#3 need System.Func<string, IFramework.UI.UIPanel>!");
                }
				...
				if (gen_param_count == 3)
				{
					...
					if (LuaAPI.xlua_is_eq_str(L, 2, "+")) {
						gen_to_be_invoked.onFindPanel += gen_delegate;
						return 0;
					} 
			...
			LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Lua.LuaGroups.onFindPanel!");
            return 0;
        }
        ...
        static int _e_onSubscribe(RealStatePtr L)
        {
		    try {
			    ...
			    int gen_param_count = LuaAPI.lua_gettop(L);
			IFramework.Hotfix.Lua.LuaGroups gen_to_be_invoked = (IFramework.Hotfix.Lua.LuaGroups)translator.FastGetCSObj(L, 1);
                System.Func<IFramework.UI.UIPanel, bool> gen_delegate = translator.GetDelegate<System.Func<IFramework.UI.UIPanel, bool>>(L, 3);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#3 need System.Func<IFramework.UI.UIPanel, bool>!");
                }
