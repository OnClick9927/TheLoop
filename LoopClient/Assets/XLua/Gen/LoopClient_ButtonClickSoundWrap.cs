...
namespace XLua.CSObjectWrap
{
    ...
    public class LoopClientButtonClickSoundWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LoopClient.ButtonClickSound);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LoopClient.ButtonClickSound gen_ret = new LoopClient.ButtonClickSound();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LoopClient.ButtonClickSound constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                LoopClient.ButtonClickSound gen_to_be_invoked = (LoopClient.ButtonClickSound)translator.FastGetCSObj(L, 1);
