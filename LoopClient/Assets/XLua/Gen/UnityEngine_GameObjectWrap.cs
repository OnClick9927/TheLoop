...
using IFramework.Tweens;using IFramework.Hotfix.Lua;
...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 15, 9, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DoActive", _m_DoActive);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DoActive(RealStatePtr L)
        {
		    try {
                ...
                {
                    bool _end = LuaAPI.lua_toboolean(L, 2);
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    
                        IFramework.Tweens.ITween<bool> gen_ret = gen_to_be_invoked.DoActive( _end, _duration );
