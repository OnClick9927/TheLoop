...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineLightWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 12, 32, 31);
        ...
        static int _m_DoColor(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Light.DoColor!");
        ...
        static int _m_DoAlpha(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Light.DoAlpha!");
