...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixAssetAssetsToolSceneAssetAwaiterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Asset.AssetsTool.SceneAssetAwaiter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<IFramework.Hotfix.Asset.SceneAsset>(L, 2))
				{
					...
					IFramework.Hotfix.Asset.AssetsTool.SceneAssetAwaiter gen_ret = new IFramework.Hotfix.Asset.AssetsTool.SceneAssetAwaiter(_task);
				...
				{
				    translator.Push(L, default(IFramework.Hotfix.Asset.AssetsTool.SceneAssetAwaiter));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Asset.AssetsTool.SceneAssetAwaiter constructor!");
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Asset.AssetsTool.SceneAssetAwaiter gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
