...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkUIExamplePanel02Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.UI.Example.Panel02);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					IFramework.UI.Example.Panel02 gen_ret = new IFramework.UI.Example.Panel02();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.UI.Example.Panel02 constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                IFramework.UI.Example.Panel02 gen_to_be_invoked = (IFramework.UI.Example.Panel02)translator.FastGetCSObj(L, 1);
