...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIToggleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DoToggle", _m_DoToggle);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DoToggle(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<bool> gen_ret = gen_to_be_invoked.DoToggle( _end, _duration );
