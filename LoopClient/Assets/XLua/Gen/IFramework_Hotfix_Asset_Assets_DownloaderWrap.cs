...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixAssetAssetsDownloaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Asset.Assets.Downloader);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 5 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5))
				{
					...
					IFramework.Hotfix.Asset.Assets.Downloader gen_ret = new IFramework.Hotfix.Asset.Assets.Downloader(_url, _downloadPath, _timeout, _retries);
				...
				if(LuaAPI.lua_gettop(L) == 4 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4))
				{
					...
					IFramework.Hotfix.Asset.Assets.Downloader gen_ret = new IFramework.Hotfix.Asset.Assets.Downloader(_url, _downloadPath, _timeout);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING))
				{
					...
					IFramework.Hotfix.Asset.Assets.Downloader gen_ret = new IFramework.Hotfix.Asset.Assets.Downloader(_url, _downloadPath);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					IFramework.Hotfix.Asset.Assets.Downloader gen_ret = new IFramework.Hotfix.Asset.Assets.Downloader(_url);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Asset.Assets.Downloader constructor!");
        ...
        static int _m_Start(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Asset.Assets.Downloader gen_to_be_invoked = (IFramework.Hotfix.Asset.Assets.Downloader)translator.FastGetCSObj(L, 1);
