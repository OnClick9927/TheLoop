        ...
        static int _m_DoText(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 5);
                    
                        IFramework.Tweens.ITween<int> gen_ret = gen_to_be_invoked.DoText( _start, _end, _duration, _snap );
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        IFramework.Tweens.ITween<int> gen_ret = gen_to_be_invoked.DoText( _start, _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 5);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoText( _start, _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoText( _start, _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                {
                    string _end = LuaAPI.lua_tostring(L, 2);
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    
                        IFramework.Tweens.ITween<int> gen_ret = gen_to_be_invoked.DoText( _end, _duration );
                        translator.PushAny(L, gen_ret);
