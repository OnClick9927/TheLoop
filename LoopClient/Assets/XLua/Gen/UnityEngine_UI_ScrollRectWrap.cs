...
using IFramework;using IFramework.Tweens;
...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIScrollRectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DoNormalizedPositionX", _m_DoNormalizedPositionX);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DoNormalizedPositionY", _m_DoNormalizedPositionY);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DoNormalizedPositionX(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoNormalizedPositionX( _end, _duration, _snap );
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoNormalizedPositionX( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoNormalizedPositionX( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoNormalizedPositionX( _values, _duration );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.UI.ScrollRect.DoNormalizedPositionX!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DoNormalizedPositionY(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoNormalizedPositionY( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoNormalizedPositionY( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoNormalizedPositionY( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoNormalizedPositionY( _values, _duration );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.UI.ScrollRect.DoNormalizedPositionY!");
