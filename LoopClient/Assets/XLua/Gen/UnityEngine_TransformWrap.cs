...
using IFramework;using IFramework.Tweens;using IFramework.Hotfix.Lua;
...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 42, 19, 13);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DoRota", _m_DoRota);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DoRotaFast", _m_DoRotaFast);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DoLocalRota", _m_DoLocalRota);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoMove( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoMove( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Vector3[] _values = (UnityEngine.Vector3[])translator.GetObject(L, 2, typeof(UnityEngine.Vector3[]));
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                    
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoMove( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoMove( _values, _duration );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveX( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveX( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    float[] _values = (float[])translator.GetObject(L, 2, typeof(float[]));
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                    
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveX( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveX( _values, _duration );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveY( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveY( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveY( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveY( _values, _duration );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveZ( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveZ( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveZ( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoMoveZ( _values, _duration );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoLocalMove( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoLocalMove( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoLocalMove( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoLocalMove( _values, _duration );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveX( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveX( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveX( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveX( _values, _duration );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveY( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveY( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveY( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveY( _values, _duration );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveZ( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveZ( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveZ( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoLocalMoveZ( _values, _duration );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoScale( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoScale( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoScale( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoScale( _values, _duration );
                        translator.PushAny(L, gen_ret);
        ...
        static int _m_DoScaleX(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleX( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleX( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleX( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleX( _values, _duration );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.DoScaleX!");
        ...
        static int _m_DoScaleY(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleY( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleY( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleY( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleY( _values, _duration );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.DoScaleY!");
        ...
        static int _m_DoScaleZ(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleZ( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleZ( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleZ( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoScaleZ( _values, _duration );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.DoScaleZ!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DoRota(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Quaternion>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Quaternion _end;translator.Get(L, 2, out _end);
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                    
                        IFramework.Tweens.ITween<UnityEngine.Quaternion> gen_ret = gen_to_be_invoked.DoRota( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Quaternion>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Quaternion> gen_ret = gen_to_be_invoked.DoRota( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoRota( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoRota( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Quaternion[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Quaternion[] _values = (UnityEngine.Quaternion[])translator.GetObject(L, 2, typeof(UnityEngine.Quaternion[]));
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                    
                        IFramework.Tweens.ITween<UnityEngine.Quaternion> gen_ret = gen_to_be_invoked.DoRota( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Quaternion[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Quaternion> gen_ret = gen_to_be_invoked.DoRota( _values, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoRota( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Vector3> gen_ret = gen_to_be_invoked.DoRota( _values, _duration );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.DoRota!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DoRotaFast(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Quaternion> gen_ret = gen_to_be_invoked.DoRotaFast( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Quaternion> gen_ret = gen_to_be_invoked.DoRotaFast( _end, _duration );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.DoRotaFast!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DoLocalRota(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Quaternion>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Quaternion> gen_ret = gen_to_be_invoked.DoLocalRota( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Quaternion>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Quaternion> gen_ret = gen_to_be_invoked.DoLocalRota( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Quaternion[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Quaternion> gen_ret = gen_to_be_invoked.DoLocalRota( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Quaternion[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Quaternion> gen_ret = gen_to_be_invoked.DoLocalRota( _values, _duration );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.DoLocalRota!");
