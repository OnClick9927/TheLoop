...
namespace XLua.CSObjectWrap
{
    ...
    public class LoopClientLoopClientAssetsSettingWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LoopClient.LoopClientAssetsSetting);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LoopClient.LoopClientAssetsSetting gen_ret = new LoopClient.LoopClientAssetsSetting();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LoopClient.LoopClientAssetsSetting constructor!");
        ...
        static int _m_GetUrlByBundleName(RealStatePtr L)
        {
		    try {
                ...
                LoopClient.LoopClientAssetsSetting gen_to_be_invoked = (LoopClient.LoopClientAssetsSetting)translator.FastGetCSObj(L, 1);
