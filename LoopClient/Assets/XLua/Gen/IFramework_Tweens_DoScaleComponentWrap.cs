...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkTweensDoScaleComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Tweens.DoScaleComponent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					IFramework.Tweens.DoScaleComponent gen_ret = new IFramework.Tweens.DoScaleComponent();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Tweens.DoScaleComponent constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Tweens.DoScaleComponent gen_to_be_invoked = (IFramework.Tweens.DoScaleComponent)translator.FastGetCSObj(L, 1);
