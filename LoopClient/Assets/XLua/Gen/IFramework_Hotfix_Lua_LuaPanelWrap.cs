...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixLuaLuaPanelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Lua.LuaPanel);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					IFramework.Hotfix.Lua.LuaPanel gen_ret = new IFramework.Hotfix.Lua.LuaPanel();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Lua.LuaPanel constructor!");
        ...
        static int _m_MakeComponentExist(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Lua.LuaPanel gen_to_be_invoked = (IFramework.Hotfix.Lua.LuaPanel)translator.FastGetCSObj(L, 1);
