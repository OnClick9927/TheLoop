...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkModulesUpdateModuleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Modules.UpdateModule);
        ...
        {
            return LuaAPI.luaL_error(L, "IFramework.Modules.UpdateModule does not have a constructor!");
        }
        ...
        static int _m_SetActive(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Modules.UpdateModule gen_to_be_invoked = (IFramework.Modules.UpdateModule)translator.FastGetCSObj(L, 1);
