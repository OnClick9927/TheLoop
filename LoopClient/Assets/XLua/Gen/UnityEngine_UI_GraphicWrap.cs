...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIGraphicWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 25, 11, 4);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "DoAlpha", _m_DoAlpha);
        ...
        static int _m_DoColor(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Color _end;translator.Get(L, 2, out _end);
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                    
                        IFramework.Tweens.ITween<UnityEngine.Color> gen_ret = gen_to_be_invoked.DoColor( _end, _duration, _snap );
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Color>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Color> gen_ret = gen_to_be_invoked.DoColor( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Color[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    UnityEngine.Color[] _values = (UnityEngine.Color[])translator.GetObject(L, 2, typeof(UnityEngine.Color[]));
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                    
                        IFramework.Tweens.ITween<UnityEngine.Color> gen_ret = gen_to_be_invoked.DoColor( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Color[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<UnityEngine.Color> gen_ret = gen_to_be_invoked.DoColor( _values, _duration );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.UI.Graphic.DoColor!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DoAlpha(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoAlpha( _end, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoAlpha( _end, _duration );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snap = LuaAPI.lua_toboolean(L, 4);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoAlpha( _values, _duration, _snap );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<float[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        IFramework.Tweens.ITween<float> gen_ret = gen_to_be_invoked.DoAlpha( _values, _duration );
                        translator.PushAny(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.UI.Graphic.DoAlpha!");
