...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkModulesMessageMessageAwaiterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Modules.Message.MessageAwaiter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<IFramework.Modules.Message.IMessage>(L, 2))
				{
					IFramework.Modules.Message.IMessage _cor = (IFramework.Modules.Message.IMessage)translator.GetObject(L, 2, typeof(IFramework.Modules.Message.IMessage));
					
					IFramework.Modules.Message.MessageAwaiter gen_ret = new IFramework.Modules.Message.MessageAwaiter(_cor);
				...
				{
				    translator.Push(L, default(IFramework.Modules.Message.MessageAwaiter));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Modules.Message.MessageAwaiter constructor!");
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Modules.Message.MessageAwaiter gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
