...
namespace XLua.CSObjectWrap
{
    ...
    public class LoopClientLoopClientUpdateWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LoopClient.LoopClientUpdate gen_ret = new LoopClient.LoopClientUpdate();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LoopClient.LoopClientUpdate constructor!");
        ...
        static int _e_downLoadProgress(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to LoopClient.LoopClientUpdate.downLoadProgress!");
            return 0;
        }
        ...
        static int _e_beginDownLoad(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to LoopClient.LoopClientUpdate.beginDownLoad!");
            return 0;
        }
        ...
        static int _e_endDownLoad(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to LoopClient.LoopClientUpdate.endDownLoad!");
            return 0;
        }
        ...
        static int _e_beginPrepare(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to LoopClient.LoopClientUpdate.beginPrepare!");
            return 0;
        }
        ...
        static int _e_endPrepare(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to LoopClient.LoopClientUpdate.endPrepare!");
            return 0;
        }
        ...
        static int _e_prepareProgress(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to LoopClient.LoopClientUpdate.prepareProgress!");
            return 0;
        }
