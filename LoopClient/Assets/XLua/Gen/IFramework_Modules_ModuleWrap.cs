...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkModulesModuleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Modules.Module);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "defaultName", IFramework.Modules.Module.defaultName);
        ...
        {
            return LuaAPI.luaL_error(L, "IFramework.Modules.Module does not have a constructor!");
        }
        ...
        static int _m_CreatInstance_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<System.Type>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    int _priority = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        IFramework.Modules.Module gen_ret = IFramework.Modules.Module.CreatInstance( _type, _name, _priority );
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Type>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        IFramework.Modules.Module gen_ret = IFramework.Modules.Module.CreatInstance( _type, _name );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<System.Type>(L, 1)) 
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        IFramework.Modules.Module gen_ret = IFramework.Modules.Module.CreatInstance( _type );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Modules.Module.CreatInstance!");
        ...
        static int _m_Bind(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Modules.Module gen_to_be_invoked = (IFramework.Modules.Module)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    IFramework.Modules.IModuleContainer _container = (IFramework.Modules.IModuleContainer)translator.GetObject(L, 2, typeof(IFramework.Modules.IModuleContainer));
        ...
        static int _m_UnBind(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Modules.Module.UnBind!");
