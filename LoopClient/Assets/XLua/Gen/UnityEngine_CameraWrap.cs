...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 48, 57, 44);
        ...
        static int _m_DoColor(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Camera.DoColor!");
        ...
        static int _m_DoAlpha(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Camera.DoAlpha!");
