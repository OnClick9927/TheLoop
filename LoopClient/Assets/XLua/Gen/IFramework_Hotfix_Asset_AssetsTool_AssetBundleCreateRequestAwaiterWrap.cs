...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixAssetAssetsToolAssetBundleCreateRequestAwaiterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Asset.AssetsTool.AssetBundleCreateRequestAwaiter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<UnityEngine.AssetBundleCreateRequest>(L, 2))
				{
					...
					IFramework.Hotfix.Asset.AssetsTool.AssetBundleCreateRequestAwaiter gen_ret = new IFramework.Hotfix.Asset.AssetsTool.AssetBundleCreateRequestAwaiter(_task);
				...
				{
				    translator.Push(L, default(IFramework.Hotfix.Asset.AssetsTool.AssetBundleCreateRequestAwaiter));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Hotfix.Asset.AssetsTool.AssetBundleCreateRequestAwaiter constructor!");
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Asset.AssetsTool.AssetBundleCreateRequestAwaiter gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
