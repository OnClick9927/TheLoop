...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkPacketsPacketWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "pkgID", _g_get_pkgID);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _size = LuaAPI.xlua_tointeger(L, 4);
                        ...
                        bool gen_ret = gen_to_be_invoked.UnPack( _buffer, _offset, _size );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_pkgID(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                IFramework.Packets.Packet gen_to_be_invoked = (IFramework.Packets.Packet)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushuint(L, gen_to_be_invoked.pkgID);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
