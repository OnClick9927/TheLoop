...
namespace IFramework.Hotfix.Asset
{
    ...
    static class AssetsEditorTool
    {
        ...
        {
            Assets.downloadDirectory = AssetBuildSetting.outputPath;
            if (AssetBuildSetting.Load().fastMode)
            {
                Assets.AssetCreater += Assets_AssetCreater;
                Assets.SceneAssetCreater += Assets_SceneAssetCreater;
                Assets.GetAllAssetPath += Assets_GetAllAssetPath;
                Assets.fastMode = true;
            }
            else
            {
                Assets.GetAllAssetPath -= Assets_GetAllAssetPath;
